...
class SampleApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, PageTwo, PageTree):
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button2 = tk.Button(self, text="Log ind (Lærer)",
                            command=lambda: controller.show_frame("PageTwo"))

        button3 = tk.Button(self, text="Log ind (Admin)",
        ...
        textentry.pack(side="bottom", pady = 50)
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        label = tk.Label(self, text="Bestiling af varer", font=controller.title_font)
        label.pack(side="top", fill="x", pady=200, padx=400)
        button = tk.Button(self, text="Log ud",
                           command=lambda: controller.show_frame("StartPage"))
        button.pack()

        button2 = tk.Button(self, text="Godkend Order",
...
class PageTree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        label = tk.Label(self, text="Oversigt over varer", font=controller.title_font)
        label.pack(side="top", fill="x", pady=10)
        button = tk.Button(self, text="Godkend order",
                           command=lambda: controller.show_frame("PageFour"))


        button2 = tk.Button(self, text="Log ud",
                            command=lambda: controller.show_frame("StartPage"))

        button3 = tk.Button(self, text="Ret order",
                            command=lambda: controller.show_frame("PageTwo"))
